...
const services = ["TwitPic", "Twipple", "Photozou", "yFrog", "Instagram", "Flickr", "picplz", "MyPict.me", "ow.ly", "YouTube", "TwitVid", "Twitter"];
...
EchofonPhotoBackend.prototype = {
  ...
  detectService: function() {
    var ret = this._url.match('https?://'+
                              ...
                              '(p\.twipple\.jp/[A-Za-z0-9]+)|'+
                              '(photozou\.jp/photo/show/[0-9]+/[0-9]+)|'+
                              '(yfrog\.com/\\w+)|'+
                              ...
                              '(mypict\.me/\\w+)|' +
                              '(ow\.ly/i/[A-Za-z0-9]+)|'+
                              '((?:www\.)?youtube\.com/(?!user/)\\S+|youtu\.be/\\S+)|'+
                              '((?:www\.)?twitvid\.com/\\w+)'+
                              ')');
    if (ret) {
  ...
  thumbnailURL: function(target_elem) {
    ...
    case "Twipple":
      return url.replace(/http:\/\/p\.twipple\.jp\/(\w+)/, 'http://p.twipple.jp/show/thumb/$1');
    case "Photozou":
      return url.replace(/http:\/\/photozou\.jp\/photo\/show\/[0-9]+\/([0-9]+)/, 'http://photozou.jp/p/thumb/$1');
    case "yFrog":
      return url + ":small";
    case "Instagram":
    ...
    case "ow.ly":
      return url.replace(/http:\/\/ow\.ly\/i\/(\w+)/, 'http://static.ow.ly/photos/thumb/$1.jpg');
    case "TwitVid":
      return url + ":thumb";
    case "YouTube":
      var vid = null;
  ...
  photoURL: function(target_elem) {
    ...
    case "Twipple":
      return url.replace(/http:\/\/p\.twipple\.jp\/(\w+)/, 'http://p.twipple.jp/show/large/$1');
    case "Photozou":
      return url.replace(/http:\/\/photozou\.jp\/photo\/show\/[0-9]+\/([0-9]+)/, 'http://photozou.jp/p/img/$1');
    case "yFrog":
      return url + ":iphone";
    case "MyPict.me":
    ...
    case "TwitVid":
      return "";
    case "ow.ly":
      return url.replace(/http:\/\/ow\.ly\/i\/(\w+)/, 'http://static.ow.ly/photos/normal/$1.jpg');
